...
export let sync = sequelize.sync({ force: production ? false : true }).then(() => {
    if (!production)
        return County.bulkCreate([
            ...
            .then(() =>
                Issue.bulkCreate([{  issueId: 1,
                    title: 'Dumme folk ødeleger lømp',
                    content: 'Disse dumme folka som komemr rett fra byen ødeleger lamper kvelden til midtnatt',
                    image: 'https://www.thesun.co.uk/wp-content/uploads/2018/07/AF-COMPOSITE-FIGHT.jpg?strip=all&quality=100&w=750&h=500&crop=1',
                    longitude: 60.656877,
                    latitude: 10.824107,
                    ...
                    { issueId: 2, title: 'Veilys på gata hjemme er ødelagt',
                    ...
                    { issueId: 3, title: 'Dårlig grafitti på skole veggen',
                    ...
                    { issueId: 4, title: 'Veilys ødelagt på 33',
