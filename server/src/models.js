...
export let Municipal: Class<Model<{ mun_id?: number, name: string, municipalShield?: string }>> = sequelize.define(
  'Municipal',
  {
...
export let County: Class<Model<{ county_id?: number, name: string, countyShield?: string }>> = sequelize.define(
  'County',
  {
