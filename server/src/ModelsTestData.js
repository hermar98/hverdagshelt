...
class ModelsTestData {
  createAll() {
    return this.createCounties()
      .then(() =>
        // this.createAllMunicipals()).then(()=>
        this.createMunicipals()
      )
      .then(() => this.createUsers())
      .then(() => this.createStatuses())
      .then(() => this.createIssueCategory())
      .then(() => this.createIssues())
      .then(() => this.createFeedback())
      .then(() => this.createEventCategory())
      .then(() => this.crateEvent())
      .then(() => this.createUserMunicipal())
      .then(() => this.createUserIssue());
  }
