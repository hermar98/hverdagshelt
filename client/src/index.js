...
import { IssueLarge, IssueOverviewNormal, IssueNormal, IssueOverviewSmall, AddFeedback} from './components/issueViews/issueViews';
  ...
  ReactDOM.render(
    <HashRouter>
      <div>
        ...
        <Route exact path="/issues/:issueId/feedback" component={AddFeedback} />
